...
print("="*60)
print("[*] Monitoring time to execute run_collection.py every 30 minutes.")
print("[*] Operational window: Mon-Fri, 09:15 AM - 03:30 PM IST.")

while True:
    now = datetime.now()
    if is_market_open():
        print(f"\n[*] Market is OPEN. Triggering Nifty Analysis Pipeline at {now.strftime('%d-%b-%Y %H:%M:%S')}...")
        try:
            ...
            # Print last few lines of terminal summary
