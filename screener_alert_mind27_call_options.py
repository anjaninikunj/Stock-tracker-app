...
SCREENER_URL = "https://chartink.com/screener/copy-mind27-everyday-call-options-look-up-967"

def format_alert_message(stocks):
    """Formats the alert message using the Stock mind27- EveryDay Call Options template."""
    ...
    message_lines = [
        f"🚀 {header_time_str} | Stock mind27 - EveryDay Call Options Look Up",
        "",
        f"Total Stocks: {total_stocks}",
        "",
        "Scanner: Stock mind27- EveryDay Call Options look up",
        "",
        "Stocks:"
    ]
...
def main():
    try:
        ...
        chartink_utils.track_performance("Stock mind27- EveryDay Call Options look up", stocks)
